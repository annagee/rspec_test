...
def select_elements_starting_with_a(array)
  array.select { |letter| letter[0].downcase == 'a' }

end

# keep only the elements that start with a vowel
def select_elements_starting_with_vowel(array)
  array.select { |letter| letter[0].downcase == 'a' ||letter[0].downcase =='o' || letter[0].downcase =='i' || letter[0].downcase =='e'}
...
def remove_nils_and_false_from_array(array)
    array.delete_if { |letter| letter == nil || letter == false}
...
def array_sort_by_last_letter_of_word(array)
  array.sort_by{|letter| letter.slice(-1)}
